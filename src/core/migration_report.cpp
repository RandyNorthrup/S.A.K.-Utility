...
QString MigrationReport::formatHtmlReport() const {
    ...
    out << "<div class=\"stat-box\"><div class=\"stat-value\">" << m_metadata.total_apps
        << "</div><div class=\"stat-label\">Total Apps</div></div>\n";
    out << "<div class=\"stat-box\"><div class=\"stat-value\">" << m_metadata.matched_apps
        << "</div><div class=\"stat-label\">Matched Apps</div></div>\n";
    ...
    out << "<table>\n<thead>\n<tr>\n";
    out << "<th>App Name</th><th>Version</th><th>Publisher</th><th>Chocolatey "
           "Package</th><th>Confidence</th><th>Match Type</th><th>Selected</th>\n";
    out << "</tr>\n</thead>\n<tbody>\n";
