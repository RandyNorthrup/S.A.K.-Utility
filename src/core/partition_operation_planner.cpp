...
void insertHfsRisks(QHash<int, OperationRisk>* risks) {
    const RiskEntryList entries = {
        ...
        {static_cast<int>(PartitionOperationType::HfsReplaceResourceFork),
         OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsGrowResourceFork), OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsTruncateResourceFork),
         OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsCreateEmptyFile), OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsCreateFile), OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsDeleteEmptyFile), OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsDeleteFile), OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsCreateEmptyFolder),
         OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsDeleteEmptyFolder),
         OperationRisk::Destructive},
        {static_cast<int>(PartitionOperationType::HfsDeleteFolderTree), OperationRisk::Destructive},
