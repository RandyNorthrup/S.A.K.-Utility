...
FixAudioIssuesAction::AudioServiceStatus FixAudioIssuesAction::checkAudioService(
    ...
    QString ps_cmd = QString("Get-Service -Name %1 | Select-Object Status | Format-List")
        .arg(service_name);
...
bool FixAudioIssuesAction::restartAudioService() {
    ...
    QString stop_cmd = "Stop-Service -Name Audiosrv -Force -ErrorAction SilentlyContinue; "
    ...
    QString start_cmd = "Start-Service -Name Audiosrv; Get-Service -Name Audiosrv | Select-Object "
                        "Status";
...
bool FixAudioIssuesAction::restartAudioEndpointBuilder() {
    ...
    QString stop_cmd = "Stop-Service -Name AudioEndpointBuilder -Force -ErrorAction "
    ...
    QString start_cmd = "Start-Service -Name AudioEndpointBuilder; Get-Service -Name "
...
int FixAudioIssuesAction::resetAudioDevices() {
    ...
    QString count_cmd = "((Get-PnpDevice -Class 'AudioEndpoint','MEDIA' | Where-Object {$_.Status "
    ...
    QString reset_cmd = "$devices = Get-PnpDevice -Class 'AudioEndpoint','MEDIA' | Where-Object "
                        "{$_.Status -ne 'Unknown'}; "
...
QString FixAudioIssuesAction::checkUSBAudioDevices() {
    ...
    QString ps_cmd = "Get-PnpDevice -Class 'USB' | Where-Object {$_.FriendlyName -like '*Audio*'} "
