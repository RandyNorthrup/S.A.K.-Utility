...
$sourceRunner = Join-Path $SharedRoot "scripts\run_partition_manager_system_mbr2gpt_external_gate.ps1"
...
if ($null -eq $process) {
    throw "Failed to start elevated system MBR2GPT gate process."
}
