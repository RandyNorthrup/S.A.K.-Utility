...
"%PS%" -NoProfile -ExecutionPolicy Bypass -Command "Start-Process -FilePath '%PS%' -Verb RunAs -ArgumentList '-NoProfile -NoExit -ExecutionPolicy Bypass -File \"\\vboxsvr\sakrepo\scripts\run_partition_manager_file_recovery_external_gate.ps1\" -TargetDiskNumber %~1 -Force'"
exit /b %ERRORLEVEL%
