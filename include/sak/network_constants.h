...
constexpr uint16_t kPortDiscovery   = 54321;  ///< Peer discovery / broadcast
constexpr uint16_t kPortControl     = 54322;  ///< Control channel
constexpr uint16_t kPortData        = 54323;  ///< Data transfer channel
constexpr uint16_t kPortRangeMin    = 1024;   ///< Lowest assignable port
constexpr uint16_t kPortRangeMax    = 65535;  ///< Highest assignable port
...
constexpr int64_t kBufferChunkDefault  = 65536;         ///< Default chunk (64 KB)
constexpr int64_t kBufferRead128K      = 131072;        ///< 128 KB read buffer
constexpr int64_t kBufferRead1MB       = 1048576;       ///< 1 MB streaming buffer
constexpr int64_t kBufferMax5MB        = 5 * 1048576;   ///< 5 MB cap (ISO chunk)
constexpr int64_t kDatagramMax         = 65536;         ///< Max UDP datagram
constexpr int64_t kMinFreeSpace64MB    = 64 * 1048576;  ///< 64 MB minimum free space
constexpr int64_t kMinFreeSpace100MB   = 100 * 1048576; ///< 100 MB minimum free space
constexpr int64_t kMinFreeSpace256MB   = 256 * 1048576; ///< 256 MB minimum free space
constexpr int64_t kMinFreeSpace512MB   = 512 * 1048576; ///< 512 MB minimum free space
constexpr int64_t kWarnFreeSpaceGB     = 16LL * 1024 * 1048576; ///< 16 GB ISO warning
...
constexpr int kAria2ConnectTimeoutLong = 30;    ///< aria2c --connect-timeout (slow)
