...
constexpr int kTimerHealthPollMs       = 10000; ///< Migration health check
...
constexpr int kTimeoutProcessMediumMs  = 10000;  ///< Medium process (aria2c start, app scan)
constexpr int kTimeoutProcessLongMs    = 30000;  ///< Long process (diskpart, bcdboot)
constexpr int kTimeoutProcessVeryLongMs= 60000;  ///< Very long process (format, listISO)
constexpr int kTimeoutProcessResetMs   = 20000;  ///< WSReset / audio reset
constexpr int kTimeoutStoreReinstallMs = 45000;  ///< Windows Store reinstall
constexpr int kTimeoutRestorePointMs   = 90000;  ///< System restore point creation
constexpr int kTimeoutDismCheckMs      = 120000; ///< DISM CheckHealth / update install
constexpr int kTimeoutBrowserCacheMs   = 180000; ///< Browser cache cleanup
constexpr int kTimeoutArchiveMs        = 300000; ///< Archive compression (5 min)
constexpr int kTimeoutDismScanMs       = 600000; ///< DISM ScanHealth (10 min)
constexpr int kTimeoutMalwareScanMs    = 900000; ///< Malware scan (15 min)
constexpr int kTimeoutSystemRepairMs   = 1800000;///< SFC / DISM RestoreHealth (30 min)
constexpr int kTimeoutDefragMs         = 3600000;///< Disk defragmentation (60 min)
constexpr int kTimeoutNetworkReadMs    = 15000;  ///< waitForReadyRead
constexpr int kTimeoutChocoListMs      = 15000;  ///< Chocolatey list packages
