...
enum class error_code {
    ...
    not_found = 408,
    elevation_denied = 409,
    elevation_timeout = 410,
    helper_connection_failed = 411,
    helper_crashed = 412,
    task_not_allowed = 413,
    privilege_failed = 414,
    ...
    pst_integrity_check_failed = 1019,
...
inline constexpr ErrorCodeMessage kErrorCodeMessages[] = {
    ...
    {error_code::pst_integrity_check_failed,
     "PST/OST integrity check failed (CRC or signature mismatch)"},
